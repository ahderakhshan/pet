...
class ParsinluFoodDataProcessor(DataProcessor):
    """
    ...
    def get_train_examples(self, data_dir: str) -> List[InputExample]:
        ...
        """
        return self._create_examples(os.path.join(data_dir, ParsinluFoodDataProcessor.TRAIN_FILE_NAME), "train")
    ...
    def get_dev_examples(self, data_dir: str) -> List[InputExample]:
        ...
        """
        return self._create_examples(os.path.join(data_dir, ParsinluFoodDataProcessor.DEV_FILE_NAME), "dev")
    ...
    def get_test_examples(self, data_dir) -> List[InputExample]:
        ...
        """
        return self._create_examples(os.path.join(data_dir, ParsinluFoodDataProcessor.TEST_FILE_NAME), "test")
    ...
    def get_unlabeled_examples(self, data_dir) -> List[InputExample]:
        ...
        """
        return self._create_examples(os.path.join(data_dir, ParsinluFoodDataProcessor.UNLABELED_FILE_NAME), "unlabeled")

    def get_labels(self) -> List[str]:
        """This method returns all possible labels for the task."""
        return ParsinluFoodDataProcessor.LABELS
    ...
    def _create_examples(self, path, set_type, max_examples=-1, skip_first=0):
        ...
        with open(path) as f:
            ...
            for idx, row in enumerate(reader):
                guid = "%s-%s" % (set_type, idx)
                label = row[ParsinluFoodDataProcessor.LABEL_COLUMN]
                text_a = row[ParsinluFoodDataProcessor.TEXT_A_COLUMN]
                text_b = row[ParsinluFoodDataProcessor.TEXT_B_COLUMN] if ParsinluFoodDataProcessor.TEXT_B_COLUMN >= 0 else None
                example = InputExample(guid=guid, text_a=text_a, text_b=text_b, label=label)
                examples.append(example)
...
class ParsinluMovieDataProcessor(DataProcessor):
    """
    Example for a data processor.
    """
    ...
    def get_train_examples(self, data_dir: str) -> List[InputExample]:
        ...
        :return: a list of train examples
        """
        return self._create_examples(os.path.join(data_dir, ParsinluMovieDataProcessor.TRAIN_FILE_NAME), "train")
    ...
    def get_dev_examples(self, data_dir: str) -> List[InputExample]:
        ...
        :return: a list of dev examples
        """
        return self._create_examples(os.path.join(data_dir, ParsinluMovieDataProcessor.DEV_FILE_NAME), "dev")
    ...
    def get_test_examples(self, data_dir) -> List[InputExample]:
        ...
        :return: a list of test examples
        """
        return self._create_examples(os.path.join(data_dir, ParsinluMovieDataProcessor.TEST_FILE_NAME), "test")
    ...
    def get_unlabeled_examples(self, data_dir) -> List[InputExample]:
        ...
        :return: a list of unlabeled examples
        """
        return self._create_examples(os.path.join(data_dir, ParsinluMovieDataProcessor.UNLABELED_FILE_NAME), "unlabeled")

    def get_labels(self) -> List[str]:
        """This method returns all possible labels for the task."""
        return ParsinluMovieDataProcessor.LABELS
    ...
    def _create_examples(self, path, set_type, max_examples=-1, skip_first=0):
        ...
        with open(path) as f:
            ...
            for idx, row in enumerate(reader):
                guid = "%s-%s" % (set_type, idx)
                label = row[ParsinluMovieDataProcessor.LABEL_COLUMN]
                text_a = row[ParsinluMovieDataProcessor.TEXT_A_COLUMN]
                text_b = row[ParsinluMovieDataProcessor.TEXT_B_COLUMN] if ParsinluMovieDataProcessor.TEXT_B_COLUMN >= 0 else None
                example = InputExample(guid=guid, text_a=text_a, text_b=text_b, label=label)
                examples.append(example)
...
class ParsinluNLIProcessor(DataProcessor):
    """
    Example for a data processor.
    """
    ...
    def get_train_examples(self, data_dir: str) -> List[InputExample]:
        ...
        :return: a list of train examples
        """
        return self._create_examples(os.path.join(data_dir, ParsinluNLIProcessor.TRAIN_FILE_NAME), "train")
    ...
    def get_dev_examples(self, data_dir: str) -> List[InputExample]:
        ...
        :return: a list of dev examples
        """
        return self._create_examples(os.path.join(data_dir, ParsinluNLIProcessor.DEV_FILE_NAME), "dev")
    ...
    def get_test_examples(self, data_dir) -> List[InputExample]:
        ...
        :return: a list of test examples
        """
        return self._create_examples(os.path.join(data_dir, ParsinluNLIProcessor.TEST_FILE_NAME), "test")
    ...
    def get_unlabeled_examples(self, data_dir) -> List[InputExample]:
        ...
        :return: a list of unlabeled examples
        """
        return self._create_examples(os.path.join(data_dir, ParsinluNLIProcessor.UNLABELED_FILE_NAME), "unlabeled")

    def get_labels(self) -> List[str]:
        """This method returns all possible labels for the task."""
        return ParsinluNLIProcessor.LABELS
    ...
    def _create_examples(self, path, set_type, max_examples=-1, skip_first=0):
        ...
        with open(path) as f:
            ...
            for idx, row in enumerate(reader):
                guid = "%s-%s" % (set_type, idx)
                label = row[ParsinluNLIProcessor.LABEL_COLUMN]
                text_a = row[ParsinluNLIProcessor.TEXT_A_COLUMN]
                text_b = row[ParsinluNLIProcessor.TEXT_B_COLUMN] if ParsinluNLIProcessor.TEXT_B_COLUMN >= 0 else None
                example = InputExample(guid=guid, text_a=text_a, text_b=text_b, label=label)
                examples.append(example)
...
class DigikalaTcProcessor(DataProcessor):
    """
    Example for a data processor.
    """
    ...
    # Set this to a list of all labels in the train + test data
    LABELS = ["عمومی", "راهنمای خرید", "بازی ویدیویی", "کتاب و ادبیات", "سلامت و زیبایی", "هنر و سینما", "علم و تکنولوژی"]
    ...
    def get_train_examples(self, data_dir: str) -> List[InputExample]:
        ...
        :return: a list of train examples
        """
        return self._create_examples(os.path.join(data_dir, DigikalaTcProcessor.TRAIN_FILE_NAME), "train")
    ...
    def get_dev_examples(self, data_dir: str) -> List[InputExample]:
        ...
        :return: a list of dev examples
        """
        return self._create_examples(os.path.join(data_dir, DigikalaTcProcessor.DEV_FILE_NAME), "dev")
    ...
    def get_test_examples(self, data_dir) -> List[InputExample]:
        ...
        :return: a list of test examples
        """
        return self._create_examples(os.path.join(data_dir, DigikalaTcProcessor.TEST_FILE_NAME), "test")
    ...
    def get_unlabeled_examples(self, data_dir) -> List[InputExample]:
        ...
        :return: a list of unlabeled examples
        """
        return self._create_examples(os.path.join(data_dir, DigikalaTcProcessor.UNLABELED_FILE_NAME), "unlabeled")

    def get_labels(self) -> List[str]:
        """This method returns all possible labels for the task."""
        return DigikalaTcProcessor.LABELS
    ...
    def _create_examples(self, path, set_type, max_examples=-1, skip_first=0):
        ...
        with open(path) as f:
            ...
            for idx, row in enumerate(reader):
                guid = "%s-%s" % (set_type, idx)
                label = row[DigikalaTcProcessor.LABEL_COLUMN]
                text_a = row[DigikalaTcProcessor.TEXT_A_COLUMN]
                text_b = row[DigikalaTcProcessor.TEXT_B_COLUMN] if DigikalaTcProcessor.TEXT_B_COLUMN >= 0 else None
                example = InputExample(guid=guid, text_a=text_a, text_b=text_b, label=label)
                examples.append(example)
...
class FarexstanceDataProcessor(DataProcessor):
    """
    Example for a data processor.
    """
    ...
    # Set this to the name of the file containing the unlabeled examples
    UNLABELED_FILE_NAME = "unlabled.csv"

    # Set this to a list of all labels in the train + test data
    LABELS = ["agree", "disagree", "unrelated", "discuss"]
    ...
    def get_train_examples(self, data_dir: str) -> List[InputExample]:
        ...
        :return: a list of train examples
        """
        return self._create_examples(os.path.join(data_dir, FarexstanceDataProcessor.TRAIN_FILE_NAME), "train")
    ...
    def get_dev_examples(self, data_dir: str) -> List[InputExample]:
        ...
        :return: a list of dev examples
        """
        return self._create_examples(os.path.join(data_dir, FarexstanceDataProcessor.DEV_FILE_NAME), "dev")
    ...
    def get_test_examples(self, data_dir) -> List[InputExample]:
        ...
        :return: a list of test examples
        """
        return self._create_examples(os.path.join(data_dir, FarexstanceDataProcessor.TEST_FILE_NAME), "test")
    ...
    def get_unlabeled_examples(self, data_dir) -> List[InputExample]:
        ...
        :return: a list of unlabeled examples
        """
        return self._create_examples(os.path.join(data_dir, FarexstanceDataProcessor.UNLABELED_FILE_NAME), "unlabeled")

    def get_labels(self) -> List[str]:
        """This method returns all possible labels for the task."""
        return FarexstanceDataProcessor.LABELS
    ...
    def _create_examples(self, path, set_type, max_examples=-1, skip_first=0):
        ...
        with open(path) as f:
            ...
            for idx, row in enumerate(reader):
                guid = "%s-%s" % (set_type, idx)
                label = row[FarexstanceDataProcessor.LABEL_COLUMN]
                text_a = row[FarexstanceDataProcessor.TEXT_A_COLUMN]
                text_b = row[FarexstanceDataProcessor.TEXT_B_COLUMN] if FarexstanceDataProcessor.TEXT_B_COLUMN >= 0 else None
                example = InputExample(guid=guid, text_a=text_a, text_b=text_b, label=label)
                examples.append(example)
...
PROCESSORS = {
    ...
    "ax-g": AxGProcessor,
    "ax-b": AxBProcessor,
    "parsinlu-food-sentiment": ParsinluFoodDataProcessor,
    "parsinlu-movie-sentiment": ParsinluMovieDataProcessor,
    "parsinlu-nli": ParsinluNLIProcessor,
    "digikala-tc": DigikalaTcProcessor,
    "farexstance": FarexstanceDataProcessor,
